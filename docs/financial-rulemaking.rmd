...
#remove nominate diff legend color
#make nominate_diff absolute value
...
p +
  ...
  geom_ribbon(aes(ymax = b0 + b1*nominate_diff+ b2*Estimate + 1.96*0.656, 
                  ymin = b0 + b1*nominate_diff+ b2*Estimate - 1.96*0.656), alpha = .1, color = NA) +
  labs(y = "Congressional Success", x = "Congressmember's Ideological Distance from President")
